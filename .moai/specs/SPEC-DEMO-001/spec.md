...
- MSQPay SDK (@solo-pay/gateway-sdk)를 서버사이드에서 사용
...
**UBIQUITOUS** 시스템은 MSQPay SDK (@solo-pay/gateway-sdk)를 workspace 의존성으로 추가해야 한다.
...
- TypeScript
- MSQPayClient SDK (@solo-pay/gateway-sdk)
- pnpm workspace
