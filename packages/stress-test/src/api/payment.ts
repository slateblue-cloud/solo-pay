...
const PAYMENT_GATEWAY_ABI = [
  'function pay(bytes32 paymentId, address tokenAddress, uint256 amount, address recipientAddress, bytes32 merchantId, uint16 feeBps, uint256 deadline, bytes calldata serverSignature, tuple(uint256 deadline, uint8 v, bytes32 r, bytes32 s) permit) external',
];
